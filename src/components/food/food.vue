<template>
	...
	<!-- 过滤器转换时间 --><div class="time">{{rating.rateTime | formatDate}}</div>
							<p class="text">
...
export default{
	...
	methods:{
		show:function(){
			...
			this.selectType = ALL;
			this.onlyContent = true;//每次打开页面初始化一下
...
.food .food-content .content .detail span{
	font-size: 10px;
...
.food .food-content .content .cartcontrol{
	position: absolute;
	right: 18px;
	bottom: 18px;
}
...
.food .food-content .rating-wrapper .rating-item .user{
	position: absolute;
	right: 0;
	top: 16px;
	line-height: 12px;
...
.food .food-content .rating-wrapper .rating-item .user .name{
...
.food .food-content .rating-wrapper .rating-item .user .avatar{
	border-radius: 50%;
	height: 12px;
	width: 12px;
}
.food .food-content .rating-wrapper .rating-item .time{
	margin-bottom: 8px;
	line-height: 12px;
	font-size: 10px;
	color: rgb(147,153,159);
}
.food .food-content .rating-wrapper .rating-item .text{
	line-height: 16px;
	font-size: 12px;
	color: rgb(7,17,27);
}
.food .food-content .rating-wrapper .rating-item .text span{
	margin-right: 4px;
	line-height: 16px;
	font-size: 12px;
	color: rgb(147,153,159);
}
.food .food-content .rating-wrapper .rating-item .text .icon-thumb_up{
	color: rgb(0,160,220);
}
